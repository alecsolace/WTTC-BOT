...
import {Member, Manufacturer, Ship, MemberShip} from "@/entities";
...
export class SyncService {
    ...
    async syncAll() {
        ...
        await this.syncShips();
        // You can add more syncs here
    }
    ...
    async syncMembers() {
        try {
            ...
            this.logger.log(`Error syncing members: ${error}`, "error");
        }
    }
    ...
    async syncManufacturers() {
        try {
            ...
            this.logger.log(`Error syncing manufacturers: ${error}`, "error");
        }
    }
    ...
    async syncShips() {
        try {
            ...
            this.logger.log(`Error syncing ships: ${error}`, "error");
        }
    }
}
